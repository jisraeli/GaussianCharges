...
systemTest = forcefield.createSystem(pdb.topology, nonbondedMethod=app.Ewald, 
    nonbondedCutoff=1.0*nanometers, constraints=app.HBonds, rigidWater=True, 
    ewaldErrorTolerance=0.0005)

print "this is a template TIP3P Ewald energy test for ", InFile
...
print "Total Ewald Energy: ", simulationTest.context.getState(getEnergy=True, groups=2).getPotentialEnergy()
print "Forces: " 
