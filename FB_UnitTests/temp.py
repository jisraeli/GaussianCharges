...
pdb.topology.setUnitCellDimensions(nanometers*(2.48,2.48,2.48))
forcefield = app.ForceField('/home/jisraeli/src/GaussianCharges/TIP3G_Basic.xml')
...
simulation.reporters.append(app.StateDataReporter('TIP3G_VV_1fs.csv', 100, step=True, 
