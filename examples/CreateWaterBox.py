...
def parse_cmdln():
        ...
        parser.add_option('-o','--out-file', dest='outfile', type='string', default='2.3_2.3_2.3_WaterBox.pdb')
...
def run(options):
        ...
        fixer.addSolvent(boxSize=Vec3(2.3,2.3,2.3)*nanometers, padding=None, 
